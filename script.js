...
var scenario = {
  ...
  oneb:{
    lifeChange: "9",
    image: 'Frage1.png',  //This is the classroom. The first choice you will have to make in this game.
    text: "Nachdem du entschieden hast, dich auf den Weg zur nächstgelegenen Hafenstadt zu machen, um dort sesshaft zu werden, begegnet dir auf halber Strecke ein Handelstrupp, mit dem du ein kurzes Gespräch führst. Als du einem der Männer von deinem Vorhaben erzählst, schaut er dich verwundert an, und sagt, dass das alles andere als eine gute Idee wäre. Warum hält der Händler nichts Gutes vom Leben in einer Handelsstadt? Warum hält der Händler nichts Gutes vom Leben auf einem Schiff? Das Leben ist in Handelsstädten um einiges teurer als an anderen Orten. In Handelsstädten gibt es aufgrund der wertvollen Güter viele Diebstähle und andere Verbrechen. Durch die vielen fahrenden Händler und Käufer, die von Weitem kommen, kann die Pest sehr leicht in die Stadt geschleppt werden.",
  ...
  four: {
    lifeChange: "0",
    image: 'abstand.png',
    text: "Nach einiger Zeit in deinem Beruf bekommst du zu hören, dass sich die Pest mittlerweile auch in dem kleinen Dorf neben deinem Haus ausgebreitet hat. Deine Familie fürchtet sich davor, ebenfalls angesteckt zu werden. Wie könntest du dich vor einer Ansteckung der Pest schützen?",
  ...
  nine: { 
    lifeChange: "0",
    image: 'Frage5.png', 
    text: "Keine guten Neuigkeiten – Trotz des Einhaltens deiner gesetzten Maßnahmen, zeigt eines deiner Familienmitglieder Symptome einer Pesterkrankung. Was ist der beste Schritt um weitere Infektionen in deiner Familie zu vermeiden?",
  ...
  eleven: {
    lifeChange: "0",
    image: 'juden.PNG',
    text: "Super! Die Quarantäne ist bis heute die effektivste Möglichkeit, um die Ausbreitung ansteckender Krankheiten einzudämmen. Obwohl der Bischof deinen Rat beherzigt, fragt er auch einige andere Dorfbewohner, wie man gegen die Pest am besten vorgehen kann. Welche Maßnahme wurde zur Zeit der Pest oft vorgeschlagen und durchgeführt?",
